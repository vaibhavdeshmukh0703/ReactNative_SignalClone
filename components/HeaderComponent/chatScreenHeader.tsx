      ...
      <SafeAreaView style={styles.container}>
          <View style={styles.personInfoContainer}>
              <Image source={{
                 ...
                 <Text style={styles.personName}>Elon Musk</Text>
          </View> 
...
const styles = StyleSheet.create({
    ...
    personInfoContainer:{ flex:4,flexDirection:"row", alignItems:"center", marginLeft:70},
    personImage: { height: 40, width: 40, borderRadius: 20, },
    personName: {color:"white", marginLeft: 10, fontSize: 20, fontWeight: 'bold' },
    iconContainer:{ marginRight:100,flex:0.5,flexDirection:"row",justifyContent:"space-between"}
